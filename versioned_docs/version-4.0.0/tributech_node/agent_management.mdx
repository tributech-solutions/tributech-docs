...
In this section we show the available management function provided by a Tributech Node user interface to manage a Tributech Agents access:
...
This options are available in the ***Enrollment*** Section of the Tributech Node
...
or [Agent Enrollment](../tributech_agent/agent_enrollment.mdx).
