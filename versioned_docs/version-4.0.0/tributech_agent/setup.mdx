...
will be able to submit data is defined in [Digital Twin Configuration](../tributech_node/agent/management.mdx#configuring-an-agent)  of an Agent.
...
To complete the configuration of a Tribtech Agent visit the [configuration section](../tributech_node/agent/management.mdx#configuring-an-agent).
