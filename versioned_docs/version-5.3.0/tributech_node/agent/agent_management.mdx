...
import AgentLifecycleLight from './img/agent-lifecycle-light.png';
import AgentLifecycleDark from './img/agent-lifecycle-dark.png';
...
<ThemedImage
  alt="Tributech Agent management Lifecycle"
  sources={{
    light: AgentLifecycleLight,
    dark: AgentLifecycleDark,
  }}
/>
