...
![Health Check REST API endpoints in the Swagger UI](./img/HealthCheck-REST-API-endpoints.png)

An example Health Check response:

![Example Health Check REST API response](./img/HealthCheck-REST-API-sample.png)
