...
We can now add a new Beckhoff TwinCat ADS Source with the three dots menu on the right side of the Device Edge entry.
...
We can then add a new ADS Stream with the three dots menu on the right side of the ADS Source entry:
