...
| :--- | :------------------------------- | :--------------------- |
| CPU  | 1 Core (x86-64 / ARM32 ) or more | The minimum requirements for small and medium workloads.  |
| RAM  | 1 GB                             | The minimum requirements for small and medium workloads. |
| Storage | 459,6 MB | Storage requirements can differ based on used service, in the minimum requirements we have: Agent = 221 MB, Broker = 11,6 MB, Source = 227 MB. |
