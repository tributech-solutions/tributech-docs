...
| :--- | :------------------------------- | :--------------------- |
| CPU  | 1 Core (x86-64 / ARM32 ) or more | The minimum requirements are recommended for small and medium workloads based on the volume of data processed.* |
| RAM  | 1 GB                             | The Tributech Agent itself does not consume that much RAM, but depending on the volume of data processed the requirements could rise.** |
*Small and medium workloads for example mean 1 to 10 streams with a refreshrate of 1 to 10Hz qhich lead to a peak at a 15% cpu load

**Ram consumption for 1 to 10 streams with 1 to 10Hz peaks at around 200MB
