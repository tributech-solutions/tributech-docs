...
The Tributech Agent Edge services can be run using [**Docker Engine**](https://docs.docker.com/engine/) as a container runtime. We use [**Docker Compose**](https://docs.docker.com/compose/) for management/orchestration of the Docker services and provide examples for [**Docker-Compose**](./setup/docker-compose/docker-compose-setup.mdx) and [**Azure**](./setup/azure/azure-setup.mdx) .
