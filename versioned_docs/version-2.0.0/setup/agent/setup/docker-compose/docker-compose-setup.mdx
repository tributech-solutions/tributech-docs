...
In this section we provide an example configuration of a Tributech Edge Agent services running on [**Docker / Docker Compose**](../../overview.md#docker-runtime) runtime. We also provide a [**fully automated**](../azure/azure-setup.mdx) setup for azure.
...
## Prerequisite 
Recent Linux based system meeting our [**requirements**](#requirements), e.g. our [**automated setup**](#agent-automated-setup) creates an Ubuntu 20.04 based Linux virtual machine on Azure.
...
[![asciicast](https://asciinema.org/a/7rIgnD7Rqafi15Smdj1MVEKXj.svg)](https://asciinema.org/a/7rIgnD7Rqafi15Smdj1MVEKXj)

## Setup the agent {#agent-manual-setup}
...
In Order to send data to the [**Tributech Node**](../../../node.md) a [**Source**](./source-setup.mdx) must be connected to the to the agent. 
