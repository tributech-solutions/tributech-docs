...
![Block a Tributech Agent via Agents Overview](../img/node-agent-management-block-agent-overview.png)

or in the Enrollment Section:

![Block a Tributech Agent via Agents Overview](../img/node-agent-management-block-enrollment-overview.png)
...
![Block a Tributech Agent via UI](../img/node-agent-management-block-agent.png)
...
![Unblock a Tributech Agent via UI](../img/node-agent-management-unblock-sample.png)
...
![Unblock Wait a Tributech Agent via UI](../img/node-agent-management-unblock-sample-await.png)
...
![Unblock Wait a Tributech Agent via UI](../img/node-agent-management-unblock-sample-online.png)
