...
The Tributech Simulated Source allows us to simulate a data source for testing purposes. After linking an [Tributech Agent](../quickstart.md) we can configure the Agent.

## Setup
In the following section we will describe the setup of a Tributech Simulated Source. 
