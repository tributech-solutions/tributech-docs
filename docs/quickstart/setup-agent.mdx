...
No we will deploy a DSK Edge Agent with a DSK Edge Simulated Sensor/Source and link it to our Data Owner Node.
...
* The *Steel Factory Plant Line* template provides a full example twin configuration for the DSK Edge Agent and Simulated Sensor/Source which you can adapt to your desire.
...
After our DSK Edge Agent and Simulated Sensor/Source was deployed, linked and configured it will be present on the DSK Node as Agent and auto-generated Dataset.
